				...
				<div class="col-md-8">
					...
					<div class="form-group">
						<label>Department</label><input class="form-control" type="text"
							autocomplete="off" required="" name="department">
					</div>
					<div class="form-group">
						<label>Registration ID</label><input class="form-control"
							type="text" autocomplete="off" name="regid" value= <%= request.getAttribute("regno")%> disabled>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label>DOB<input class="form-control" type="date" name="date"></label>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label>Mobile No<input class="form-control" type="tel" name="mobileno"></label>
					</div>
					<hr>
					<div class="form-row">
