		...
		<form action="Register" method="post" >
			<div class="form-row profile-row">
				...
				<div class="col-md-8">
					...
					<div class="form-row">
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label>FirstName </label><input class="form-control" name="fname" value= <%= request.getAttribute("fname")%> disabled>
							</div>
						</div>
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<label>Lastname </label><input class="form-control" type="text" name="lname" value= <%= request.getAttribute("lname")%> disabled>
							</div>
						</div>
					</div>
					<div class="form-group">
						<label>Mother Name</label><input class="form-control" type="text"   name="motherName" required="" >
					</div>
					<div class="form-group">
						<label>Father Name</label><input class="form-control" type="text"
							 required="" name="fatherName" >
					</div>
					<div class="form-group">
						<label>Email</label><input class="form-control" type="text"
							autocomplete="off" required="" name="email" value= <%= request.getAttribute("email") %> disabled>
					</div>
					...
					<div class="form-group">
						<label>Registration Number</label><input class="form-control" value= <%= request.getAttribute("regno") %>
							type="text"   name="regno" readonly>
					</div>
					<div class="form-group">
						<label>Course<select class="form-control" id="course" name="course"><optgroup>
